...
//
// No Dashboard (Início) este componente não renderiza nada: logo,
// saudação e avatar vivem dentro do próprio card da hero (ver page.tsx,
// .hero-header-row), garantindo a MESMA cor de fundo — duas caixas
// separadas, por mais parecidas, sempre deixavam uma diferença sutil
// perceptível na emenda.
